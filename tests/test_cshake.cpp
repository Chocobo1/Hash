...
TEST_CASE("cshake-256")
{
	...
	Hash h19(512);
	Hash::BaseType h19_2(1088 / 8);
	h19 = h19_2;
	REQUIRE(h19.finalize().toVector() == h19_2.finalize().toVector());
	h19 = std::move(h19_2);
	REQUIRE(h19.finalize().toVector() == Hash::BaseType(1088 / 8).finalize().toVector());
}
...
TEST_CASE("cshake-128")
{
	...
	Hash h19(512);
	Hash::BaseType h19_2(1344 / 8);
	h19 = h19_2;
	REQUIRE(h19.finalize().toVector() == h19_2.finalize().toVector());
	h19 = std::move(h19_2);
	REQUIRE(h19.finalize().toVector() == Hash::BaseType(1344 / 8).finalize().toVector());
}
