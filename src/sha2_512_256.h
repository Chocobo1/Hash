...
namespace SHA2_512_256_NS
{
	class SHA2_512_256
	{
		...
		public:
			...
			void reset();
			SHA2_512_256& finalize();  // after this, only `toArray()`, `toString()`, `toVector()`, `reset()` are available
	...
	SHA2_512_256& SHA2_512_256::finalize()
	{
	...
	SHA2_512_256::ResultArrayType SHA2_512_256::toArray() const
	{
	...
	SHA2_512_256& SHA2_512_256::addData(const Span<const Byte> inData)
	{
	...
	SHA2_512_256& SHA2_512_256::addData(const void *ptr, const long int length)
	{
		// gsl::span::index_type = long int
		return addData({reinterpret_cast<const Byte*>(ptr), length});
	}

	void SHA2_512_256::addDataImpl(const Span<const Byte> data)
	{
