...
namespace SHA2_512_224_NS
{
	class SHA2_512_224
	{
		...
		public:
			...
			CONSTEXPR_CPP17_CHOCOBO1_HASH SHA2_512_224& addData(Span<const Byte> inData);
			CONSTEXPR_CPP17_CHOCOBO1_HASH SHA2_512_224& addData(const void *ptr, std::size_t length);
			template <std::size_t N>
			CONSTEXPR_CPP17_CHOCOBO1_HASH SHA2_512_224& addData(const Byte (&array)[N]);
			template <typename T, std::size_t N>
			SHA2_512_224& addData(const T (&array)[N]);
			template <typename T>
			SHA2_512_224& addData(Span<T> inSpan);

			friend constexpr bool operator==(const SHA2_512_224 &left, const SHA2_512_224 &right)
			{
				for (int i = 0; i < 8; ++i)
				{
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH inline SHA2_512_224& SHA2_512_224::finalize()
	{
	...
	inline std::string SHA2_512_224::toString() const
	{
	...
	inline std::vector<SHA2_512_224::Byte> SHA2_512_224::toVector() const
	{
		const auto digest = toArray();
		return {digest.begin(), digest.end()};
	}

	CONSTEXPR_CPP17_CHOCOBO1_HASH inline SHA2_512_224::ResultArrayType SHA2_512_224::toArray() const
	{
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH inline SHA2_512_224& SHA2_512_224::addData(const Span<const Byte> inData)
	{
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH inline SHA2_512_224& SHA2_512_224::addData(const void *ptr, const std::size_t length)
	{
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH inline void SHA2_512_224::addDataImpl(const Span<const Byte> data)
	{
