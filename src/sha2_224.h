...
namespace SHA2_224_Hash
{
	...
	SHA2_224& SHA2_224::addData(const Span<const Byte> inData)
	{
	...
	SHA2_224& SHA2_224::addData(const void *ptr, const long int length)
	{
		// gsl::span::index_type = long int
		return addData({reinterpret_cast<const Byte*>(ptr), length});
	}

	void SHA2_224::addDataImpl(const Span<const Byte> data)
	{
	...
	using SHA2_224 = SHA2_224_Hash::SHA2_224;
}
