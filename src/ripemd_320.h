...
namespace RIPEMD_320_NS
{
	class RIPEMD_320
	{
		...
		public:
			...
			CONSTEXPR_CPP17_CHOCOBO1_HASH RIPEMD_320& finalize();  // after this, only `operator T()`, `reset()`, `toArray()`, `toString()`, `toVector()` are available
			...
			CONSTEXPR_CPP17_CHOCOBO1_HASH RIPEMD_320& addData(Span<const Byte> inData);
			CONSTEXPR_CPP17_CHOCOBO1_HASH RIPEMD_320& addData(const void *ptr, std::size_t length);
			template <std::size_t N>
			CONSTEXPR_CPP17_CHOCOBO1_HASH RIPEMD_320& addData(const Byte (&array)[N]);
			template <typename T, std::size_t N>
			RIPEMD_320& addData(const T (&array)[N]);
			template <typename T>
			RIPEMD_320& addData(Span<T> inSpan);
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH inline RIPEMD_320& RIPEMD_320::finalize()
	{
	...
	inline std::string RIPEMD_320::toString() const
	{
	...
	inline std::vector<RIPEMD_320::Byte> RIPEMD_320::toVector() const
	{
		const auto digest = toArray();
		return {digest.begin(), digest.end()};
	}

	CONSTEXPR_CPP17_CHOCOBO1_HASH inline RIPEMD_320::ResultArrayType RIPEMD_320::toArray() const
	{
	...
	template <typename T>
	CONSTEXPR_CPP17_CHOCOBO1_HASH RIPEMD_320::operator T() const noexcept
	{
		static_assert(std::is_unsigned<T>::value, "");
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH inline RIPEMD_320& RIPEMD_320::addData(const Span<const Byte> inData)
	{
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH inline RIPEMD_320& RIPEMD_320::addData(const void *ptr, const std::size_t length)
	{
	...
	CONSTEXPR_CPP17_CHOCOBO1_HASH inline void RIPEMD_320::addDataImpl(const Span<const Byte> data)
	{
...
{
	template <>
	struct hash<Chocobo1::RIPEMD_320>
	{
		CONSTEXPR_CPP17_CHOCOBO1_HASH size_t operator()(const Chocobo1::RIPEMD_320 &hash) const noexcept
		{
			return hash;
		}
	};
