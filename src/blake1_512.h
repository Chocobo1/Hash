...
namespace Blake1_512_NS
{
	...
	constexpr Blake1_512& Blake1_512::addData(const void *ptr, const std::size_t length)
	{
	...
	constexpr void Blake1_512::addDataImpl(const Span<const Byte> data, const int paddingLen)
	{
