...
namespace Blake1_512_Hash
{
	class Blake1_512
	{
		...
		public:
			...
			inline explicit Blake1_512();

			inline void reset();
			inline Blake1_512& finalize();  // after this, only `toString()`, `toVector()`, `reset()` are available

			inline std::string toString() const;
			inline std::vector<Blake1_512::Byte> toVector() const;

			inline Blake1_512& addData(const Span<const Byte> inData);
			inline Blake1_512& addData(const void *ptr, const long int length);
	...
	Blake1_512& Blake1_512::finalize()
	{
	...
	Blake1_512& Blake1_512::addData(const Span<const Byte> inData)
	{
	...
	Blake1_512& Blake1_512::addData(const void *ptr, const long int length)
	{
		// gsl::span::index_type = long int
		return addData({reinterpret_cast<const Byte*>(ptr), length});
	}

	void Blake1_512::addDataImpl(const Span<const Byte> data, const uint32_t paddingLen)
	{
	...
	using Blake1_512 = Blake1_512_Hash::Blake1_512;
}
